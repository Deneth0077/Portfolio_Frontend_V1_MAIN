        ...
        <div className="flex flex-col-reverse lg:grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          <div className="space-y-6 text-center lg:text-left">
            ...
            <p 
              ...
              data-aos-duration="1500"
            >
              I am an enthusiastic, passionate, and creative Information undergraduate at SLIIT. I thrive in collaborative environments and am committed to continuous learning and growth. I am eager to apply my skills and grow as a Software Engineer Intern to gain practical experience, contribute to impactful projects, and develop professionally in the field of software engineering.
            </p>

            <div className="flex flex-col lg:flex-row items-center lg:items-start gap-4 lg:gap-4 lg:px-0 w-full">
              <a href="https://drive.google.com/file/d/1G0brr5vvFsg6sBgIfe4E20r3Gieqgf2-/view?usp=drive_link" className="w-full">
              <button 
                data-aos="fade-up"
                data-aos-duration="800"
